...
public class Skill : ScriptableObject
{
    ...
    */
    ...
    // ApplyStatus(StatusEffect status, StatSheet target) - Applies the [status] status effect to the [target]. Call this multiple times to apply multiple stacks. [status] IS AN INT IN THE CONTEXT OF [skillSequence], use an int for [status] equal to its index in the list.
